...
void mpu6050Class::sensorAngle()
{
	...
	angle_x=filtergain*angle_x_gyro+(1-filtergain)*angle_x_accel;
	angle_y=filtergain*angle_y_gyro+(1-filtergain)*angle_y_accel;
	angle_z=filtergain*angle_z_gyro+(1-filtergain)*angle_z_accel;
